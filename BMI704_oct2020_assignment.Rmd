...
### Optional questions
1) Similarly, how does the biological interpretation of a species-level vs. a family-level association change?

2) We only showed that confounding is happening based on the fact that the association output change. How would you identify the specific confounders that are affecting specific microbial features? 

3) You have 31 microbes that may be associated with T2D. Propose a follow-up experiment in the wet lab to test if they are causal for disease.
